...
def scrape_laptops():
    ...
    for laptop in laptops:
        title = laptop.find('h3').get_text(strip=True)
        ...
        cursor.execute('''INSERT INTO currys_laptops (title, price, link, scraped_at)
                          VALUES (%s, %s, %s, %s)''', (title, price, link, datetime.now()))
