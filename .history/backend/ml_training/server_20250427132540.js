...
app.post('/api/confirm_bnpl_order', authenticateUser, async (req, res) => {
    ...
    try {
        ...
        const orderData = {
            ...
            loan_amnt: orderAmount,    // *** CORRECTED: Use orderAmount ***
        ...
        const orderSql = 'INSERT INTO orders (user_id, assessment_id, product_title, product_price, loan_amount, selected_term_months, remaining_balance, order_status, next_payment_due_date, order_timestamp) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
