        ...
        <div className='container'>
            <BackButton />
             <div className='form-card'>
                ...
                {linkSuccess && <p className='assessment-approved' style={{marginTop: '15px', textAlign: 'center'}}>✅ Bank account linked successfully (Simulated)!</p>}
                <p style={{marginTop: '30px', textAlign: 'center'}}>
                    <span
                        className="link-lookalike" // Assuming this class styles it like a link
                        onClick={() => navigate('/dashboard')}
                        style={{cursor: 'pointer', color: 'blue', textDecoration: 'underline'}} // Example inline styles for link
                    >
                        Back to Dashboard
                    </span>
                </p>
