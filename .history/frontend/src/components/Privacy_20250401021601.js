  ...
  return (
    <div className="container">
      <div className="form-card">
        ...
        <p>All data is securely stored in accordance with UK law regarding financial services and credit lending.</p>
        ...
        <p>We take your data protection seriously and comply with UK data protection laws, including the General Data Protection Regulation (GDPR). This ensures that your data is only used for the purposes outlined in our privacy policy. If you have any questions about what we store and how your data is used you can use the button below to request a copy of your data sent to your email. If you opt out, we will take all necessary steps to ensure your data is erased from our records within 2 weeks.</p>
