...
const Register = () => {
  ...
  const [showPopup, setShowPopup] = useState(false); // Show confirmation popup
  const [isRedirecting, setIsRedirecting] = useState(false); // Track if redirecting
  ...
  return (
    <div className="container">
      ...
      {/* Popup Confirmation */}
      {showPopup && !isRedirecting && (
        <div className="popup">
          <p>Account successfully created! Redirecting to login...</p>
        </div>
      )}
    </div>
  );
