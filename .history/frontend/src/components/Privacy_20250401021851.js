  ...
  return (
    <div className="container">
      <div className="form-card">
        ...
        <p>All data is securely stored in compliance with UK financial services and credit lending laws, including data protection regulations such as the General Data Protection Regulation (GDPR), ensuring your data is only used for the purposes outlined in our privacy policy. If you have any questions about what we store and how your data is used you can use the button below to request a copy of your data sent to your email. If you opt out, we will take all necessary steps to ensure your data is erased from our records within 2 weeks.</p>
