        ...
        {filteredProducts.length > 0 ? (
          filteredProducts.slice(0, 9).map((product, index) => (
            <div key={index} className="product-card" onClick={() => setSelectedProduct(product)}>
              ...
              <img src={product.img || 'default-image.jpg'} alt={product.title} />
              <h3>{product.title}</h3>
              <p>{product.price}</p>
      ...
      {selectedProduct && (
        <div className="modal">
          <div className="modal-content">
            ...
            <img src={selectedProduct.img || 'default-image.jpg'} alt={selectedProduct.title} />
            <h2>{selectedProduct.title}</h2>
            <p>{selectedProduct.price}</p>
            <p><a href={selectedProduct.link} target="_blank" rel="noopener noreferrer">View on Currys</a></p>
